...
public final class view_005fOWLObject_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t</li>\n");
      out.write("                                                        <li>\n");
      out.write("\t\t\t\t\t\t\t\tManage Object Property\n");
      out.write("\t\t\t\t\t\t\t</li>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tOntology Object Properties\n");
      out.write("\t\t\t\t\t\t\t\t</small>\n");
      out.write("\t\t\t\t\t\t\t</h1>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#modal-form\" role=\"button\" class=\"blue\" data-toggle=\"modal\"> Add Object Property </a>\n");
      out.write("\t\t\t\t\t\t\t\t</h4>\n");
      out.write("\n");
      out.write("                                                                \n");
      out.write("                                                                <div class=\"row\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Object Property Name</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Object Property IRI</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th></th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</thead>\n");
      ...
      out.write("                                                                            <form class=\"form-horizontal\" role=\"form\" id=\"form_submit\" method=\"post\" action=\"MainOWLObject\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<label class=\"col-sm-4 control-label no-padding-right\" for=\"form-field-1\"> Object Property Name </label>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-8\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"objectName\" name=\"objectName\" class=\"col-xs-10 col-sm-10\" />\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("                            \n");
      out.write("                            $(\"#objectName\").keydown(function (e) {\n");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("                                                                                                                                </button></a>\n");
          out.write("\n");
          out.write("                                                                                                                            <a href=\"DeleteOWLObject?name=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ont.getIRI().getFragment()}", java.lang.String.class, (PageContext)_jspx_page_context, null));
