...
public final class view_005fOWLIndividual_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\tOntology Individuals\n");
      out.write("\t\t\t\t\t\t\t\t</small>\n");
      out.write("\t\t\t\t\t\t\t</h1>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#modal-form\" role=\"button\" class=\"blue\" data-toggle=\"modal\"> Add Individual </a>\n");
      out.write("\t\t\t\t\t\t\t\t</h4>\n");
      out.write("\n");
      out.write("                                                                \n");
      out.write("                                                                <div class=\"row\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Individual Name</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th>Individual IRI</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<th></th>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</thead>\n");
      ...
      out.write("                                                                            <form class=\"form-horizontal\" role=\"form\" id=\"form_submit\" method=\"post\" action=\"MainOWLIndividual\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<label class=\"col-sm-4 control-label no-padding-right\" for=\"form-field-1\"> Individual Name </label>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-8\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"indName\" name=\"indName\" class=\"col-xs-10 col-sm-10\" />\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("                            \n");
      out.write("                            $(\"#indName\").keydown(function (e) {\n");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\n");
          out.write("\n");
          out.write("                                                                                                                            <a href=\"ViewIndividual?name=");
          ...
          out.write("                                                                                                                                </button></a>\n");
          out.write("\n");
          out.write("                                                                                                                            <a href=\"DeleteOWLIndividual?name=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ont.getIRI().getFragment()}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" onclick=\"return confirm('Are you sure you want to delete ");
          if (_jspx_meth_c_out_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_forEach_0, _jspx_page_context, _jspx_push_body_count_c_forEach_0))
            return true;
          out.write(" Individual?');\"><button class=\"btn btn-xs btn-danger\">\n");
          ...
          if (_jspx_meth_c_out_4((javax.servlet.jsp.tagext.JspTag) _jspx_th_c_forEach_0, _jspx_page_context, _jspx_push_body_count_c_forEach_0))
            return true;
          out.write(" Individual?');\" class=\"tooltip-error\" data-rel=\"tooltip\" title=\"Delete\">\n");
