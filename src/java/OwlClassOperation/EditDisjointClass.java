 ...
 * @author amar_
 */
public class EditDisjointClass extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
          ...
          String disjointclassName= request.getParameter("disjoint");
...
OWLClass disjointclazz = null;
    ...
    if (cls.getIRI().getFragment().equals(disjointclassName)){
              
        disjointclazz = factory.getOWLClass(cls.getIRI());
    }
   
            }
          
          
          OWLAxiom oldaxiom = factory.getOWLDisjointClassesAxiom(clazz, disjointclazz);
...
assertNotNull(ontology);
OWLClass clazz = null;
OWLClass newdisjointclazz = null;
    ...
    if (cls.getIRI().toString().equals(newdisjoint)){
              
        newdisjointclazz = factory.getOWLClass(cls.getIRI());
    }
            }
  
          OWLAxiom newaxiom = factory.getOWLDisjointClassesAxiom(clazz, newdisjointclazz);
