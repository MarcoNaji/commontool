 ...
 * @author amar_
 */
public class EditEquivalentObject extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
          ...
          String equivalentobjectName= request.getParameter("equivalent");
...
OWLObjectProperty equivalentobject = null;
    ...
    if (obj.getIRI().getFragment().equals(equivalentobjectName)){
              
        equivalentobject = factory.getOWLObjectProperty(obj.getIRI());
    }
   
            }
          
          
          OWLAxiom oldaxiom = factory.getOWLEquivalentObjectPropertiesAxiom(object, equivalentobject);
...
assertNotNull(ontology);
OWLObjectProperty object = null;
OWLObjectProperty newequivalentobject = null;
    ...
    if (obj.getIRI().toString().equals(newequivalent)){
              
        newequivalentobject = factory.getOWLObjectProperty(obj.getIRI());
    }
            }
  
          OWLAxiom newaxiom = factory.getOWLEquivalentObjectPropertiesAxiom(object, newequivalentobject);
