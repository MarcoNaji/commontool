 ...
 * @author amar_
 */
public class EditRangeData extends HttpServlet {
...
OWLDatatype range = null;
    ...
    if (type.getIRI().getFragment().equals(rangeName)){
              
        range = factory.getOWLDatatype(type.getIRI());
    }
            }
          
          
          OWLAxiom oldaxiom = factory.getOWLDataPropertyRangeAxiom(data, range);
...
OWLDatatype newtype = null;
    ...
    if (type.getIRI().toString().equals(newrange)){
              
        newtype = factory.getOWLDatatype(type.getIRI());
    }
            }
         
              OWLAxiom newaxiom = factory.getOWLDataPropertyRangeAxiom(data, newtype);
