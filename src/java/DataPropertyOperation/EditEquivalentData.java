 ...
 * @author amar_
 */
public class EditEquivalentData extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
          ...
          String equivalentdataName= request.getParameter("equivalent");
...
OWLDataProperty equivalentdata = null;
    ...
    if (dat.getIRI().getFragment().equals(equivalentdataName)){
              
        equivalentdata = factory.getOWLDataProperty(dat.getIRI());
    }
   
            }
          
          
          OWLAxiom oldaxiom = factory.getOWLEquivalentDataPropertiesAxiom(data, equivalentdata);
...
assertNotNull(ontology);
OWLDataProperty data = null;
OWLDataProperty newequivalentdata = null;
    ...
    if (dat.getIRI().toString().equals(newequivalent)){
              
        newequivalentdata = factory.getOWLDataProperty(dat.getIRI());
    }
            }
  
          OWLAxiom newaxiom = factory.getOWLEquivalentDataPropertiesAxiom(data, newequivalentdata);
