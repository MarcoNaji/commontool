 ...
 * @author amar_
 */
public class MainOWLData extends HttpServlet {
   ...
   String msg = dataName + " was deleted successfully.";
   ...
   String msg = "Data property already exist!";
...
request.setAttribute("ontology", ontdata);


//response.getWriter().println(ontclass);
    // Forward to to the JSP file.
    request.getRequestDispatcher("view_OWLData.jsp").forward(request, response);
...
OWLDataProperty o = factory.getOWLDataProperty(IRI.create(ontologyIRI+"#"+dataName));
