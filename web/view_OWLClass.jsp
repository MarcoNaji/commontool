						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<a href="#modal-form" role="button" class="blue" data-toggle="modal"> Add Class </a>
								</h4>
													...
													<tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                                                                                            ...
                                                                                                                            <a href="ViewClass?name=${ont.getIRI().getFragment()}"><button class="btn btn-xs btn-info">
																	<i class="icon-zoom-in bigger-120"></i>
                                                                                                                                </button></a>

                                                                                                                            <a href="DeleteOWLClass?name=${ont.getIRI().getFragment()}" onclick="return confirm('Are you sure you want to delete <c:out value="${ont.getIRI().getFragment()}"/> class? All subclasses of this class will be parentless.');"><button class="btn btn-xs btn-danger">
															...
															<div class="visible-xs visible-sm hidden-md hidden-lg">
																<div class="inline position-relative">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
																		...
																		<li>
																			<a href="ViewClass?name=${ont.getIRI().getFragment()}" class="tooltip-success" data-rel="tooltip" title="View">
																				<span class="green">
																					<i class="icon-zoom-in bigger-120"></i>
																				</span>
																			</a>
																		...
																		<li>
																			<a href="DeleteOWLClass?name=${ont.getIRI().getFragment()}" onclick="return confirm('Are you sure you want to delete <c:out value="${ont.getIRI().getFragment()}"/> class? All subclasses of this class will be parentless.');" class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
																					<i class="icon-trash bigger-120"></i>
																				</span>
																			</a>
								...
								<!-- PAGE CONTENT ENDS -->
									...
									<div class="modal-dialog">
                                                                            <form class="form-horizontal" role="form" id="form_submit" method="post" action="MainOWLClass">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="className" name="className" class="col-xs-10 col-sm-10" />
										</div>
									</div>
